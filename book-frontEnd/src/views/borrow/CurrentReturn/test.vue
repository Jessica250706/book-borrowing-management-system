<template>
  <div class="return-book-page">
    ...
    <!-- 核心表格组件 (使用SimpleTable) - 移除额外容器，直接滑动表格 -->
    <SimpleTable
      ref="tableRef"
      :data="bookList"
      :columns="columns"
