...
class Http {
    ...
    private interceptors() {
        ...
        this.instance.interceptors.request.use((config: InternalAxiosRequestConfig) => {
            ...
            let token =
                'eyJhbGciOiJIUzUxMiJ9.eyJleHAiOjE2NzE5ODMwMzksInN1YiI6ImFkbWluIiwiaWF0IjoxNjUzOTgzMDM5NTQzfQ.Ai_Lcq0tE7 -GurWqjng86gGn_WWVWN9jOx6yHeueP9nqxDDWft_h5SeopsQIiUewYbZvCiKSJKUP_E8bMRdWxw';
            if (token) {
